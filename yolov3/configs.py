...
YOLO_CUSTOM_WEIGHTS         = "checkpoints/yolov4_custom_Tiny" # "checkpoints/yolov3_custom" # used in evaluate_mAP.py and custom model detection, if not using leave False
...
TRAIN_DATA_AUG              = True
TRAIN_TRANSFER              = True
TRAIN_FROM_CHECKPOINT       = "checkpoints/yolov4_custom_Tiny" # "checkpoints/yolov4_custom"
TRAIN_LR_INIT               = 1e-4
TRAIN_LR_END                = 1e-6
